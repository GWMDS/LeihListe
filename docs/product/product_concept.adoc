...
Die Inventarverwaltung an Hochschulen ist keine triviale Lösung.
Gerade bei Ausleihservices ist eine gute Verwaltungssoftware mit einfach benutzbaren Oberfläche unabdingbar. So eine Lösung gibt es akutell nicht.
...
____
Für Hochschulen,
die keine Software für Ausleihservices verwenden,
ist Leihliste
ein Softwareprodukt,
das Ausleihe und Inventarverwaltung vereint.
Im Gegensatz zu SnipesIT
bietet unser Produkt eine Ausleihfunktionalität.
____
