...
| Unterstützung von CRUD-Operationen an der Inventarliste
| Hoch
...
| Benutzbarkeit
| Das Produkt ist ohne Einarbeitung nutzbar. Es gibt eine grafische Benutzeroberfläche.
...
| Ein Nutzer sollte nicht länger als eine Minute brauchen, um das Produkt nutzen zu.
...
| Bedienung
| Die Software muss Touch als Eingabe unterstützen
| Technisch
