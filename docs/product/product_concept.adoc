...
bietet unser Produkt eine Ausleihfunktionalität, damit die Hochschulgemeinschaft und externe Interessenten vom besser Hochschulinventar profitieren können.
____
