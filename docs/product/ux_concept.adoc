...
| *Verhalten & Kontext*
| Nutzt technische Geräte regelmäßig im Alltag, vor allem ihr Smartphone. Die Benutzung von Computern beschränkt größtenteils auf relevante fachliche Software, Onlinebrowsing und gelegentliche Videospiele.
...
| *Verhalten & Kontext*
| Tägliche Benutzung von technischen Geräten (insbesondere Computern) im Arbeitsalltag, sicherer Umgang mit Standardsoftware und Internetanwendungen
